...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(images/explore.jpg)"></div>
		<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content">
										<div class="home_title"><h2><br>Paquete Explorer</h2></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="contact_form_container">
						  ...
						  <div class="tab-content" style="color: black">
						      ...
						      <p style="color: black">Estimado usuario la informacion proporcionada a continuación esta sujeta a cambios sin previo aviso, de acuerdo a las politicas de la agenencia de viajes DXM.
								  ...
								  <tbody>
								    <tr>
								      <th scope="row">1</th>
								      <td>4 personas</td>
								      <td>7 dias /6 noches/ 2 habitaciones</td>
								      <td>12,000</td>
								    </tr>
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El hospedaje es para 4 personas en 2 <br>habitaciónes matrimoniales, el checkin<br> a partir de las 12pm del dia y <br>termina el hospedaje el ultimo dia a las 12 pm</td>
								      <td></td>
								    </tr>
								    <tr>
						    ...
						    <div id="menu1" class="container tab-pane fade"><br>
						      ...
						      2.-Dia 2, sabemos que su viaje por el descubirmiento debe tener un album con fotos de ustedes dos o de objetos que los representen o que sean simbólicos de su amor. y tomar fotos siguiéndose uno al otro, ¡es tan lindo! La idea es que sean fotos no tanto de los destinos que visiten <br>
						      ...
						      4.- Dia 4, organiza una noche de vivencias para platicar sobre lo que les esta gustando de la maravillosa experciencia y que es lo que aun falta por conocer.<br>
						      ...
						      6.-Dia 6, Sorprendete con las maravillosas clases de yoga para viajeros sanos, sera de gran experiencia para los integrantes y pasaran un momento inolvidable.<br>
						    ...
						    <div id="menu2" class="container tab-pane fade"><br>
	                          ...
	                          <table class="table table-bordered">
								  ...
								  <tbody>
								    ...
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El vuelo es para 4 personas <br>en clase Turista mas equipaje, el vuelo<br> sale de el Aeropuerto Benito Juarez CDMX<br>el check in y los detalles de abordaje<br>se enviaran al correo que nos proporciono mismo <br>al que deberá enviar la documentación de los viajeros</td>
								      <td></td>
								    </tr>
								    <tr>
								      <td colspan="3">Total</td>
				...
				<div class="col-lg-4">
					<div class="contact_content">
						...
						<div class="card border-light mb-3" style="max-width: 18rem;">
						  ...
						  <div class="card-body">
						    <h5 class="card-title" style="color: black">Estas pagando $22,000 por</h5>
						    <p class="card-text" style="color: black">
						    	
								  1.-Boleto redondo de avion (de las 4 personas que viajan)<br>
								  2.-Hospedaje hotel 3 estrellas<br>
