...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(images/mochi.jpg)"></div>
		<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content">
										<div class="home_title"><h2><br>Paquete Mochileros</h2></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="contact_form_container">
						  ...
						  <div class="tab-content" style="color: black">
						    <div id="home" class="container tab-pane active"><br>
						      ...
						      <p style="color: black">Estimado usuario la informacion proporcionada a continuación esta sujeta a cambios sin previo aviso, de acuerdo a las politicas de la agenencia de viajes DXM.
								  ...
								  <tbody>
								    ...
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El hospedaje es para 1 persona <br>en una habitación individual, el checkin<br> a partir de las 12pm del dia y <br>termina el hospedaje el ultimo dia a las 12 pm</td>
								      <td></td>
								    </tr>
								    <tr>
						    ...
						    <div id="menu1" class="container tab-pane fade"><br>
						      <h3>Itinerario</h3>
						      <p style="color: black">1.-LLegaste, lo primero es Documentar el check in de su hotel y poder descansar o ir a comer a uno de los restaurants que se encuentran disponibles cerca de la zona y poder conocer lo que te espera en tu maravillosa estancia.<br>
						      2.-Dia 2, sabemos que tu viaje debe tener un album con fotos de ti o de objetos que te representen o que sean simbólicos de tu viaje. y tomar fotos de vistas panoramicas, La idea es que sean fotos no tanto de los destinos que visiten <br>
						      3.-Dia 3, Una vez que te acoplaste, pueden visitar los museos y cines que estan al rededor de la zona donde se encuentra su hotel y asi porder tomar algunas fotos y hacer un collage con ellas.<br>
						      4.- Dia 4, organiza una noche especial para ti, se que ahorrar no es facil por eso planifica que es lo que sera para los dias que quedan y disfruta.<br>
						      5.-Dia 5,Lleva contigo un mapa por que lo que viene es super emocionante, ve al centro del lugar y aventurate en una experiencia magica e inolbidable, no olvides la ropa comoda. <br>
						      6.-Dia 6, Sorprendete con las maravillosas clases de yoga que tenemos para ti, sera de gran experiencia para ti y pasaras un momento inolvidable.<br>
						    ...
						    <div id="menu2" class="container tab-pane fade"><br>
	                          ...
	                          <table class="table table-bordered">
								  ...
								  <tbody>
								    ...
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El vuelo es para 1 persona <br>en clase Turista mas equipaje, el vuelo<br> sale de el Aeropuerto Benito Juarez CDMX<br>el check in y los detalles de abordaje<br>se enviaran al correo que nos proporciono</td>
								      <td></td>
								    </tr>
								    <tr>
								      <td colspan="3">Total</td>
				...
				<div class="col-lg-4">
					<div class="contact_content">
						...
						<div class="card border-light mb-3" style="max-width: 18rem;">
						  ...
						  <div class="card-body">
						    <h5 class="card-title" style="color: black">Estas pagando $17,000 por</h5>
						    <p class="card-text" style="color: black">
						    	
								  1.-Boleto redondo de avion<br>
								  2.-Hospedaje hotel economico<br>
