...
<div class="super_container">
	...
	<div class="home">
		<div class="background_image" style="background-image:url(images/desert.jpg)"></div>
		<div class="home_slider_content_container">
						<div class="container">
							<div class="row">
								<div class="col">
									<div class="home_slider_content">
										<div class="home_title"><h2><br>Paquete Familiar</h2></div>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="contact_form_container">
						  ...
						  <div class="tab-content" style="color: black">
						    <div id="home" class="container tab-pane active"><br>
						      ...
						      <p style="color: black">Estimado usuario la informacion proporcionada a continuación esta sujeta a cambios sin previo aviso, de acuerdo a las politicas de la agenencia de viajes DXM.
								  ...
								  <tbody>
								    ...
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El hospedaje es para 6 personas en 2<br>habitaciónes duplex con 3 camas individuales, el checkin<br> a partir de las 12pm del dia y <br>termina el hospedaje el ultimo dia a las 12 pm</td>
								      <td></td>
								    </tr>
								    <tr>
						    ...
						    <div id="menu1" class="container tab-pane fade"><br>
						      ...
						      2.-Dia 2, sabemos que la familia completa debe tener un album con fotos de ustedes o de objetos que los representen o que sean simbólicos de su union. y tomar fotos siguiéndose uno al otro, el propostio o la idea es que sean fotos no tanto de los destinos que visiten <br>
						      ...
						      4.- Dia 4, organiza una noche de juegos de mesa o acción llevando el juego a la realidad de manera que toda la familia pueda ser quien se divierta.<br>
						      ...
						      6.-Dia 6, Sorprendete con las maravillosas clases de yoga para familia, sera de gran experiencia para los integrantes de la familia y pasaran un momento inolvidable.<br>
						    ...
						    <div id="menu2" class="container tab-pane fade"><br>
	                          ...
	                          <table class="table table-bordered">
								  ...
								  <tbody>
								    ...
								    <tr>
								      <th scope="row">2</th>
								      <td colspan="2">El vuelo es para 6 personas <br>en clase Turista mas equipaje, el vuelo<br> sale de el Aeropuerto Benito Juarez CDMX<br>el check in y los detalles de abordaje<br>se enviaran al correo que nos proporciono mismo <br>al que deberá enviar la documentación de los viajeros</td>
								      <td></td>
								    </tr>
								    <tr>
								      <td colspan="3">Total</td>
				...
				<div class="col-lg-4">
					<div class="contact_content">
						...
						<div class="card border-light mb-3" style="max-width: 18rem;">
						  ...
						  <div class="card-body">
						    <h5 class="card-title" style="color: black">Estas pagando $40,000 por</h5>
						    <p class="card-text" style="color: black">
						    	
								  1.-Boleto redondo de avion (de 6 personas que viajan)<br>
